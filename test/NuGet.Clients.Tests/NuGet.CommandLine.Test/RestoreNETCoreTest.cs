...
namespace NuGet.CommandLine.Test
{
    public class RestoreNetCoreTest
    {
        ...
        [Fact]
        public async Task RestoreNetCore_CPVMProject_WithCentralPackageReferences_Succeeds()
        {
            // Arrange
            using (var pathContext = new SimpleTestPathContext())
            {
                ...
                solution.CentralPackageVersionsManagementFile = CentralPackageVersionsManagementFile.Create(pathContext.SolutionRoot)
                    ...
                    .SetCentralPackageReference("ToolPackageA", "1.0.0");
                solution.Create(pathContext.SolutionRoot);
        ...
        [Fact]
        public async Task RestoreNetCore_CPVMProject_WithCentralPackageReferencesButCentralPackageManagementDisabled_CentralPackageReferencesAreIgnored()
        {
            // Arrange
            using (var pathContext = new SimpleTestPathContext())
            {
